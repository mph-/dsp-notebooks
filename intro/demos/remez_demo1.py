...
def remez_demo1_plot(numtaps=20, cutoff=100, trans_width=20, fs=400,
                     mode=response_modes[2]):

    b = remez(numtaps, [0, cutoff, cutoff + trans_width,
                        0.5 * fs], [1, 0], fs=fs)
...
def remez_demo1():
    interact(remez_demo1_plot,
             numtaps=(5, 100, 5), cutoff=(10, 200, 10),
