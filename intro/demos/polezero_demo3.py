...
def polezero_demo3_plot(alpha1=5, omega1=10, alpha2=20,
    ...
    if mode == 'Step response':
        ...
        h = alpha2 * (alpha1**2 + omega1**2) * (omega1 * (omega1**2 + (alpha1 - alpha2)**2) * exp(alpha1 * t) - (omega1 * cos(omega1 * t) + (alpha1 - alpha2) * sin(omega1 * t)) * (alpha1**2 - 2 * alpha1 * alpha2 + alpha2**2 + omega1**2) * exp(alpha2 * t)) * exp(-t * (alpha1 + alpha2)) / (omega1 * (omega1**2 + (alpha1 - alpha2)**2) * (alpha1**2 - 2 * alpha1 * alpha2 + alpha2**2 + omega1**2))
        ylim = (-5, 10)
    else:
